...
export function ConversationModal({ open, onClose, model }: ConversationModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* panel */}
      <div className="relative z-10 w-[640px] max-w-[92vw] h-[80vh] flex flex-col bg-panel border border-border rounded-lg shadow-2xl overflow-hidden">
        {/* header */}
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-muted text-[10px] leading-tight font-mono">{model ?? 'model'}</div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            {messages.length > 0 && (
            ...
            <button
              ...
              className="w-7 h-7 rounded border border-border bg-card text-muted hover:text-fg flex items-center justify-center"
            >
              ✕
            </button>
          </div>
