  ...
  res.json([
    {
      ...
      ttft_p99_ms: rowA.ttft_p99_ms ?? null,
    ...
    },
    {
      ...
      ttft_p99_ms: rowB.ttft_p99_ms ?? null,
      ...
      pct_ttft_p99: pctChange(rowA.ttft_p99_ms as number, rowB.ttft_p99_ms as number),
      ...
      pct_tpot: pctChange(rowA.tpot_p50_ms as number, rowB.tpot_p50_ms as number),
    },
  ])
})
